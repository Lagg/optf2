...
CREATE TABLE IF NOT EXISTS search_count (id64 BIGINT UNSIGNED, ip VARCHAR(200), count INTEGER UNSIGNED DEFAULT 1);

CREATE TABLE IF NOT EXISTS profile_cache (id64 BIGINT UNSIGNED PRIMARY KEY, profile BLOB, timestamp INTEGER);
