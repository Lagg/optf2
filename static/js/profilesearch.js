$(document).ready(function() {
  ...
  var rpField = $("#rp-input"),
    rpFieldDefault = "Search Steam player profiles";
  rpField.addClass("inactive");
  rpField.val(rpFieldDefault);
  rpField.click(function() {
    if (rpField.hasClass("inactive")) {
      rpField.val('');
      rpField.removeClass("inactive");
    }
  });
  $("#rp-form").submit(function() {
    ...
    $.getJSON(jsConf.vRoot + "api/profileSearch", {
      user: val
    }, function(data) {
      output.empty();
