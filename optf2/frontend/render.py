...
logging.basicConfig(filename = os.path.join(config.cache_file_dir, config.game_mode + ".log"), level = logging.ERROR)
...
urls = (
    ...
    config.virtual_root + "particle_dump", app.schema_list.particles,
